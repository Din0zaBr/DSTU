"""
Главный модуль лабораторной работы по криптографии.

Предоставляет единое меню для выбора между двумя заданиями:
1. Система Вижинера
2. Шифр «Двойной квадрат» Уитстона

Примечание: В симметричной криптосистеме секретный ключ передается по защищенному каналу.
"""
