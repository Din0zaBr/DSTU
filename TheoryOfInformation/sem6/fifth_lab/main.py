...
class CommunicationChannelApp(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        # Информация о работе
        self.info_label = ctk.CTkLabel(self.sidebar_frame,
    ...
    def show_module(self, module_name):
        ...
        self.block_code_button.configure(
            fg_color=("gray75", "gray28") if module_name == "block_code" else ("gray70", "gray30"))
        self.conv_code_button.configure(
            fg_color=("gray75", "gray28") if module_name == "convolutional_code" else ("gray70", "gray30"))
