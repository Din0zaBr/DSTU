...
public class Main {
    public static void main(String[] args) {
        Main main = new Main();
        System.out.println(main.firstQuestion(""));
        System.out.println(main.secondQuestion(""));
        System.out.println(main.thirdQuestion(""));
        System.out.println(main.fourthQuestion(""));
        System.out.println(main.fifthQuestion(""));
        System.out.println(main.sixthQuestion(""));
        System.out.println(main.seventhQuestion(""));
        System.out.println(main.eighthQuestion(""));
    }
