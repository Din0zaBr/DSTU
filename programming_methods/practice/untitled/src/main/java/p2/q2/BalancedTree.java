/**
 * Задача заключается в создании сбалансированного дерева из входной коллекции элементов.
 * Сбалансированное дерево должно быть построено таким образом, чтобы на нижнем уровне было как можно больше листовых узлов.
